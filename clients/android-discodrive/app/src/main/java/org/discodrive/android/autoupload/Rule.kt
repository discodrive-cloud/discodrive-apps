 ...
 *
 * @param sourcePath absolute path of the folder on the phone
...
data class Rule(
    ...
    companion object {
        ...
        /** Unparseable storage yields no rules rather than throwing: a corrupt preference
         *  must not make the app unusable, and the user can re-add the folders. */
