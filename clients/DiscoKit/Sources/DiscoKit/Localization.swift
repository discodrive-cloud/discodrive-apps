...
public enum L10n {
    ...
    static let table: [String: [String: String]] = [
        ...
        "au.stop": ["en": "Stop", "ru": "Остановить", "uk": "Зупинити", "de": "Anhalten", "fr": "Arrêter", "es": "Detener", "sr": "Заустави"],
        "au.stopped": ["en": "Stopped. What was uploaded stays uploaded.", "ru": "Остановлено. Загруженное остаётся загруженным.", "uk": "Зупинено. Завантажене залишається завантаженим.", "de": "Angehalten. Bereits Hochgeladenes bleibt hochgeladen.", "fr": "Arrêté. Ce qui a été envoyé le reste.", "es": "Detenido. Lo ya subido permanece subido.", "sr": "Заустављено. Оно што је отпремљено остаје отпремљено."],
    ]
